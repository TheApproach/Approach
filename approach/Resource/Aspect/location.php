...
{
	public static string $proto					= 'approach:/';		// protocol
	public static string $prefix					= '/';				// path prefix such as /api/, /products/, /listings/FL_Miami/...
	public static string $where					= '';				// where the resource is located, the remaining path components
